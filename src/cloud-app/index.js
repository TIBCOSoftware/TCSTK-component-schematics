...
function addDependencies(host) {
    const dependencies = [
        { type: schematics_utilities_1.NodeDependencyType.Default, version: '4.17.10', name: 'lodash-es' }
    ];
...
function addModuleToImports(options) {
    return (host, context) => {
        ...
        schematics_utilities_1.addModuleImportToRootModule(host, moduleName, 'angular-made-with-love', project);
